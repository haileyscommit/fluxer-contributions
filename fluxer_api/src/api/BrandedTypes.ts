...
export type PersonaGroupID = Brand<bigint, 'PersonaGroupID'>;
...
export function createPersonaGroupID<T extends bigint>(id: T extends BrandedValue ? never : T): PersonaGroupID {
	return brand<T, 'PersonaGroupID'>(id);
}
